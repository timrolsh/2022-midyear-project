...
player.destination_cards.append(DestinationCard(Field.cities["New York"], Field.cities["Boston"], 10))
...
print(player.union_find.is_connected(Field.cities["New York"], Field.cities["Boston"]))
